...
<p align="center">
    <a href="https://www.npmjs.com/package/v-calendars"><img src="https://img.shields.io/npm/dt/v-calendars.svg" alt="Total Downloads"></a>
    <a href="https://github.com/peimn/v-calendars/releases"><img src="https://img.shields.io/npm/v/v-calendars.svg" alt="Latest Release"></a>
    <a href="https://github.com/peimn/v-calendars/releases"><img src="https://img.shields.io/npm/v/v-calendars/next.svg" alt="Next Release"></a>
    <a href="https://github.com/peimn/v-calendars/blob/master/LICENSE"><img src="https://img.shields.io/npm/l/v-calendars.svg" alt="License"></a>
</p>

------

```bash
npm i --save v-calendars
```
