  ...
  getMonthComps(month, year) {
    ...
    if (!comps) {
      ...
      if (['indian', 'ethiopic', 'buddhist', 'islamic-umalqura'].includes(this.calendar)) {
        ...
        const prevMonthDaysToShow = firstWeekday + (firstWeekday < this.firstDayOfWeek ? locale_daysInWeek : 0) - this.firstDayOfWeek;
    ...
    getMonthItems(year) {
      ...
      return this.locale.getMonthDates(this.locale.calendar, year).map(function (d, i) {
        ...
        return {
          ...
          year,
          id: `${year}.${pad(month, 2)}`,
          label: _this2.locale.format(d.toDate($14e0f24ef4ac5c92$export$aa8b41735afcabd2()), _this2.masks.navMonths),
          ariaLabel: _this2.locale.format(d.toDate($14e0f24ef4ac5c92$export$aa8b41735afcabd2()), 'MMMM YYYY'),
  ...
  methods: {
    ...
    getDefaultInitialPage() {
      ...
      if (this.fromPage && this.$locale.calendar !== 'gregory') {
        var _page$day;
        const gregoryDate = new CalendarDate_module_$35ea8db9cb2ccb90$export$99faa760c7908e4f(page.year, page.month, (_page$day = page.day) !== null && _page$day !== void 0 ? _page$day : 1);
        const intlDate = $11d87f3f76e88657$export$b4a036af3fc0b032(gregoryDate, this.$locale.createCalendar);
        const date = $14e0f24ef4ac5c92$export$a5a3b454ada2268e(intlDate);
        page.year = date.year;
      ...
      if (!pageIsValid(page)) {
        ...
        if (this.toPage && this.$locale.calendar !== 'gregory') {
          var _toPage$day;
          const gregoryDate = new CalendarDate_module_$35ea8db9cb2ccb90$export$99faa760c7908e4f(toPage.year, toPage.month, (_toPage$day = toPage.day) !== null && _toPage$day !== void 0 ? _toPage$day : 1);
          const intlDate = $11d87f3f76e88657$export$b4a036af3fc0b032(gregoryDate, this.$locale.createCalendar);
          const date = $14e0f24ef4ac5c92$export$a5a3b454ada2268e(intlDate);
    ...
    buildPage({
      ...
      if (!page || ignoreCache) {
        const intlDate = new CalendarDate_module_$35ea8db9cb2ccb90$export$99faa760c7908e4f(this.$locale.createCalendar, year, month, 1);
        const date = intlDate.toDate($14e0f24ef4ac5c92$export$aa8b41735afcabd2());
...
const DatePickervue_type_script_lang_js_config = [_baseConfig, _baseConfig];
const MODE = {
  DATE: 'date',
  DATE_TIME: 'datetime',
  TIME: 'time'
...
/* harmony default export */ var DatePickervue_type_script_lang_js = ({
  ...
  computed: {
    ...
    modelConfig_() {
      return this.normalizeConfig(this.modelConfig, DatePickervue_type_script_lang_js_config);
    },
    inputMask() {
  ...
  methods: {
    ...
    onInputUpdate(inputValue, isStart, opts) {
      ...
      if (this.$locale.calendar !== 'gregory') {
        ...
        let parsedDateTime = {};
        const timeZone = this.timezone === null || ((_this$timezone = this.timezone) === null || _this$timezone === void 0 ? void 0 : _this$timezone.trim()) === '' ? $14e0f24ef4ac5c92$export$aa8b41735afcabd2() : this.timezone;
        if (this.isRange) {
          ...
          let intlDate = new CalendarDate_module_$35ea8db9cb2ccb90$export$d3b7288e7994edea(this.$locale.createCalendar, '', parsedDateTime.start.year, parsedDateTime.start.month, parsedDateTime.start.day, timeZone, 0);
          intlDate = intlDate.set({
            hour,
          ...
          let intlDate = new CalendarDate_module_$35ea8db9cb2ccb90$export$d3b7288e7994edea(this.$locale.createCalendar, '', parsedDateTime.year, parsedDateTime.month, parsedDateTime.day, timeZone, 0);
          intlDate = intlDate.set({
            hour,
